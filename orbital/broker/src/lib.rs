...
///
/// Send an event to the broker where the path is packaged up in the event itself (unused)
///
...
///
/// Helper to send an event to the broker intended for a specified path
///
...
///
/// Helper to allow anybody to mount a fresh listener on a path
///
